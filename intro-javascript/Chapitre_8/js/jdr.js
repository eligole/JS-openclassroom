var Personnage = {
    ...
    initPerso: function (nom, sante, force, piece, cles) {
        this.nom = nom;
        this.sante = sante;
        this.force = force;
        this.piece = piece;
...
Joueur.decrire = function () {
    var description = this.nom + " a " + this.sante + " points de vie, " +
        this.force + " en force " + this.xp + " points d'expérience "+ this.piece + " piece(s) d'or et "+ this.cles + " clé(s)";
    return description;
};
...
Joueur.combattre = function (adversaire) {
    ...
    if (adversaire.sante === 0) {
        console.log(this.nom + " a tué " + adversaire.nom + " gagne " +
            adversaire.valeur + " points d'expérience "+ this.piece + " piece(s) d'or et "+ this.cles + " clé(s) ");
...
Adversaire.initAdversaire = function (nom, sante, force, race, valeur, piece, cles) {
    this.initPerso(nom, sante, force, piece, cles);
    this.race = race;
    this.valeur = valeur;
    //this.piece = 10;///////////////////////////////////////
